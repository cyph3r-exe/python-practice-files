...
e.grid(column=0, row=0, columnspan=3, pady =10, padx =10)

e.insert(0, "Enter your number: ") #Entry Index
...
#? defining symbols
button_addition = Button(root, text = "+", padx=39, pady=10, command =lambda: button_click())
button_equation = Button(root, text ="=", padx=91, pady=10, command =lambda: button_click())
button_clear = Button(root, text = "Clear", padx=79, pady=10, command = delete())
...
#!Symbol Buttons styling
button_clear.grid(row=4, column=1, columnspan=2)
button_addition.grid(row=5, column=0)
button_equation.grid(row=5, column=1, columnspan=2)
